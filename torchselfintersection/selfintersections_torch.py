...
class SelfIntersections(torch.nn.Module):
    ...
    @staticmethod
    def coplanar_SelfIntersectionsTorchd(p1, q1, r1, p2, q2, r2, n1, n2):
    ...
    @staticmethod
    def SelfIntersectionsTorchd_test(p1, q1, r1, p2, q2, r2, dp2, dq2, dr2, n1, n2):
        if dp2 > 0.:
            if dq2 > 0.:
            ...
            if dq2 < 0.:
                ...
                if dr2 > 0.:
                    ...
                    return SelfIntersections.coplanar_SelfIntersectionsTorchd(
    ...
    def forward(self, triangles):
        ...
        for i in range(triangles.shape[0]):
            ...
            for j in range(i + 1, triangles2.shape[0]):
                ...
                if dp1 > 0.:
                    if dq1 > 0.:
                        selfintersections[i][j] = SelfIntersections.SelfIntersectionsTorchd_test(
                    ...
                    if dq1 < 0.:
                        ...
                        if dr1 > 0.:
                            ...
                            selfintersections[i][j] = SelfIntersections.coplanar_SelfIntersectionsTorchd(
                                p1, q1, r1, p2, q2, r2, n1, n2
                            )
